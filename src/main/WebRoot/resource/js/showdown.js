...
showdown.subParser('blockQuotes', function (text, options, globals) {
  ...
  text = text.replace(rgx, function (bq) {
    ...
    bq = bq.replace(/(^|\n)/g, '$1  ');
    // These leading spaces screw with <pre> content.html, so we need to fix that:
      ...
      switch (meta.toLowerCase()) {
        ...
        case 'charset':
          if (doctype === 'html' || doctype === 'html5') {
            ...
            charset = '<meta name="charset" content.html="' + globals.metadata.parsed.charset + '">\n';
          }
          break;
        ...
        case 'lang':
          ...
          metadata += '<meta name="' + meta + '" content.html="' + globals.metadata.parsed[meta] + '">\n';
          break;
